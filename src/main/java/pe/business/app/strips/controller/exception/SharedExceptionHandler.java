...
import pe.business.app.strips.model.ErrorMessageT;
import pe.business.app.strips.model.TransactionRs;
import pe.business.app.strips.util.ErrorMessageBuilder;
...
public class SharedExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<TransactionRs<String>> handleServiceException(ServiceException ex) {
